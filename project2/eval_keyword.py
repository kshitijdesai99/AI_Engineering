"""BM25-only retrieval eval against corpus.json.

Usage:
    python eval_keyword.py [--file evals/easy.csv] [--out evals/results_easy_keyword.json] [--topk 5]
"""
import os
import argparse
import csv
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="BM25-only retrieval eval against corpus.json")
